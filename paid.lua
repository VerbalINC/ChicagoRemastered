...
local Window = OrionLib:MakeWindow({Name = "Chicago Remastered x Verbs#2775", HidePremium = true, SaveConfig = true, ConfigFolder = "Verbal Script"})
...
Tab:AddParagraph("Scripter :","Made by Verbs#2775")
 
Tab:AddParagraph("Ui libary","Name : Orion Libary by Verbs")
 
Tab:AddParagraph("No Recoil","Made by Verbs#2775")
